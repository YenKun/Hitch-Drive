...
<body class="animsition">
	...
	<div class="resCon">
		...
		<form action="<c:url value="/addName.controller" />" method="POST">
		<input type="text" id="txt1"  name="firstName"   placeholder="First name"></input>
		<input type="text" id="txt2" name="lastName" placeholder="Last name"></input>
		<input type="submit" id="submitName"  name="submitName" value="&rsaquo;&rsaquo;"></input>
		</form>
